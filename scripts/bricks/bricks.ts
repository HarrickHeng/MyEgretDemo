...
export class BricksPlugin implements plugins.Command {
    ...
    async onFinish(pluginContext: plugins.CommandContext) {
        ...
        mainJSContent = mainJSContent.replace(/contentWidth: 720/gm, `contentWidth: ${projectConfig.contentWidth}`);
        mainJSContent = mainJSContent.replace(/contentHeight: 1280/gm, `contentHeight: ${projectConfig.contentHeight}`);
